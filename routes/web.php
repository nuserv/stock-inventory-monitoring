...
Route::get('verify-service-ticket', 'StockController@verifyServiceTicket');//->middleware('ajax');
...
Route::get('request-summary', 'StockRequestController@requestSummary');//->middleware('ajax');
