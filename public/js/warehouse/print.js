                ...
                buttons: [
                    {
                        ...
                        customize: function (doc) {
                            ...
                            $(doc.document.body)
                                ...
                                .prepend('<div style="position:absolute; top:200;font-size:24px"><b>Branch name: </b>'+$('#branch').val()+'</div>')
                                .prepend('<div style="position:absolute; top:200;left:60%;font-size:24px"><b>Date Schedule:</b> '+$('#datesched').val()+'</div>')
                                .prepend('<div style="position:absolute; top:230;font-family: arial;font-size:24px"><b>Prepared By: </b>'+$("#userlog").val()+'</div>')
                                .prepend('<div style="position:absolute; top:260;font-family: arial;font-size:24px"><b>Prepared Date: </b>'+months[d.getMonth()]+' '+d.getDate()+', ' +d.getFullYear()+' '+hour+':'+String(d.getMinutes()).padStart(2, '0')+ampm+'</div>')
                                ...
                                .prepend('<div style="position:absolute; top:290;font-family: arial;font-size:24px"><b>Customer: </b>'+$('#customername').val()+'</div>')
