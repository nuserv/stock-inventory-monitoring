...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div id="loading"></div>
        ...
        @if(Request::is('request/*'))
            @if(auth()->user()->hasAnyrole('Warehouse Manager', 'Encoder'))
                <script src="{{asset('min/?f=js/warehouse/request.js&ver2.02')}}"></script>
                <script src="{{asset('min/?f=js/warehouse/request1.js&ver2.02')}}"></script>
                <script src="{{asset('min/?f=js/warehouse/request2.js&ver2.02')}}"></script>
                <script src="{{asset('min/?f=js/warehouse/request3.js&ver2.02')}}"></script>
            @endif
