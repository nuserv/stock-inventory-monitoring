...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div id="loading"></div>
        ...
        @if(Request::is('request/*'))
            @if(auth()->user()->hasAnyrole('Warehouse Manager', 'Encoder'))
                <script src="{{asset('min/?f=js/warehouse/request.js&ver1.5')}}"></script>
        ...
        @if(Request::is('request'))
            @if(auth()->user()->hasAnyrole('Warehouse Manager', 'Encoder'))
                <script src="{{asset('min/?f=js/warehouse/request.js&ver1.5')}}"></script>
                <script src="{{asset('min/?f=js/warehouse/request1.js&ver1.5')}}"></script>
                <script src="{{asset('min/?f=js/warehouse/request2.js&ver1.5')}}"></script>
                <script src="{{asset('min/?f=js/warehouse/request3.js&ver1.5')}}"></script>
            @endif
            @if(auth()->user()->hasanyrole('Editor', 'Manager', 'Warehouse Administrator'))
                <script src="{{asset('min/?f=js/request.js')}}"></script>
            @endif
