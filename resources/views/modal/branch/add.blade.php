        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="reqfield">
                <div class="row no-margin" id="row1">
                    ...
                    <div class="col-md-2 form-group">
                        <input type="text" id="serial1" class="form-control serial" row_count="1" placeholder="serial number" style="color: black" onkeypress="return event.charCode >= 47" onkeyup="checkserial(this)">
                    </div>
