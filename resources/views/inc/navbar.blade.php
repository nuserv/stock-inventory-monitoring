    ...
    <div class="navbar-collapse collapse justify-content-between align-items-center w-100">
        ...
        <ul class="nav">
            <li class="nav-item nohover" style="padding: 15px 0;">
                <a class="nav-link {{ Request::is('report-a-problem') ? 'active' : '' }}" href="http://its.ideaserv.site/" target="_blank" style="background-color: white; color:#0d1a80; font-size: 10px;border-radius: 5px;padding: 2px 0;">&nbsp;&nbsp;REPORT A PROBLEM&nbsp;&nbsp;</a>
            </li>
