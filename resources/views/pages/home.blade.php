    ...
    <table class="table activityTable" id="activityTable" style="font-size:80%">
        <thead class="thead-dark">
            <tr class="tbsearch" style="display:none">
                <td>
                    <input type="text" class="form-control filter-input fl-0" placeholder="search.." data-column="0" style="border: 1px solid black;"/>
                </td>
                <td>
                    <input type="text" class="form-control filter-input fl-1" placeholder="search.." data-column="1" style="border: 1px solid black;" />
                </td>
                <td>
                    <input type="text" class="form-control filter-input fl-2" placeholder="search.." data-column="2" style="border: 1px solid black;" />
                </td>
                <td>
