<div class="modal fade in" id="detailsBundledItems">
    <div class="modal-dialog modal-xl">
    <div class="modal-content card">
        <div class="modal-header text-center" style="border-radius: 0px; background-color: #0d1a80; color: white; height: 45px;">
            <h6 class="modal-title w-100">BUNDLED ITEMS DETAILS</h6>
        ...
        <div class="modal-body" style="background-color: white; color: black;">
            ...
            <input type="hidden" name="bundle_code_original" id="bundle_code_details_original">
            <input type="hidden" name="bundle_details_original" id="bundle_details_original">
            <div class="form-inline">
                <label class="form-control form-control-sm" style="width: 100px;">Product Code</label>
                <input class="form-control form-control-sm spChar required_field" style="width: 305px; margin-right: 10px;" name="bundle_code_details" id="bundle_code_details" maxlength="100" placeholder="Please enter product code" type="search" required tabindex="1">
                <label class="form-control form-control-sm" style="width: 140px;">Product Description</label>
                <input class="form-control form-control-sm text-capitalize required_field" style="width: 542px; margin-right: 10px;" name="bundle_details" id="bundle_details" maxlength="255" placeholder="Please enter bundled item description to proceed" type="search" required tabindex="2">
            </div>
        </div>
        <div class="modal-header text-center" style="border-radius: 0px; background-color: #0d1a80; color: white; height: 45px;">
            <h6 class="modal-title w-100">BUNDLE INCLUSIVES</h6>
        </div>
        <div class="container-fluid my-2" id="#divBundleDetails">
        ...
        <div class="modal-footer">
            ...
            <button type="button" id="btnUpdateBundle" class="btn btn-primary float-end bp">UPDATE</button>
        </div>
    </div>
    </div>
</div>
<script>
setInterval(() => {
    if(!$('#bundle_code_original').val() || $('#bundle_code_original').val() == '[BLANK]'){
        $('#show_barcode').hide();
    }
    else{
        $('#show_barcode').show();
